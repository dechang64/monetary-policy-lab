...
\begin{enumerate}
\item \textbf{GSS target + path shocks} (full decomposition): Both the target and path factors. R$^2$ = 4.12\%, path p = 0.017. Adding the path shock more than doubles the R$^2$ and reveals the path factor as the primary driver.
\end{enumerate}
...
Acosta target + path & 4.12\% & 0.017 & 117 \\\bottomrule\end{tabular}
