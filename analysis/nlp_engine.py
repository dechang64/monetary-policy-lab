...
class FOMCSentimentEngine:
    ...
    NEGATIONS = [
        "no ", "not ", "no evidence of ", "no signs of ", "no indication of ",
        "does not ", "did not ", "has not ", "have not ", "is not ",
        "are not ", "will not ", "would not ", "could not ", "should not ",
        "lack of ", "absence of ", "declining ", "decreasing ",
    ]
    ...
    def _rule_based_analyze(self, text: str) -> dict:
        """Rule-based sentiment analysis using keyword matching with negation detection."""
        ...
        # If negation detected, flip the signal
        if has_negation:
            hawkish_count, dovish_count = dovish_count, hawkish_count
