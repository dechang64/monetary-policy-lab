...
\begin{frame}{H3/H4 (Eq.~7): Information Channel and Forward Guidance}
...
\begin{itemize}
  ...
  \item Three interpretations:
    ...
    \end{enumerate}
  \item \textbf{Key finding}: Rate cut regime --- path shock \alert{highly significant} ($p < 0.001$, R$^2$ = 43.1\%)
\end{itemize}
\end{frame}

% ────────────────────────────────────────────────────────────────
\begin{frame}{Section 5.7: The Rate Cut Anomaly}
...
\midrule
Rate hike & 17 & 10.2\% & 0.013\textsuperscript{**} & 0.298 \\
\alert{Rate cut} & \alert{11} & \alert{43.1\%} & 0.089 & \alert{$<$0.001\textsuperscript{***}} \\
...
\vspace{0.5em}
\begin{itemize}
  \item Rate cut: R$^2$ is \alert{27$\times$} the full sample (1.57\%)
  ...
  \item \textbf{``Sentiment is a function of who is speaking; asset prices respond to what is decided''}
\end{itemize}
\end{frame}
