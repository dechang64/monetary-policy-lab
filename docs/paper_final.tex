...
\end{tabular}
\par\vspace{2pt}{\footnotesize Sample: 117 FOMC meetings, January 2006 to July 2022. Target and path shocks are standardized to unit variance.}
\end{table}
...
\begin{itemize}
\item Target shock: |t| = 1.651 (p = 0.102)
\item Path shock: |t| = 2.421 (p = 0.017)
\end{itemize}
...
\begin{figure}[htbp]\centering\includegraphics[width=0.85\textwidth]{fig2_h1_scatter}\caption{Sentiment vs.\ Monetary Policy Shocks}\label{fig:fig2_h1_scatter}\end{figure}
...
\end{tabular}
\par\vspace{2pt}{\footnotesize Newey-West HAC standard errors with lag=4. t-statistics in parentheses. ** $p < 0.05$, * $p < 0.10$. FG = forward guidance period indicator (Dec 2008--Dec 2015).}
\end{table}
