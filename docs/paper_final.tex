...
\author{
\begin{tabular}{c}
Dechang Yu\textsuperscript{a} \quad Eileen Zhang\textsuperscript{b} \\[6pt]
\small\textsuperscript{a} Academy of AI, Xi'an Jiaotong-Liverpool University, Suzhou, China \\
\small\textsuperscript{b} [Affiliation to be confirmed]
\end{tabular}
}
\date{}
...
\noindent\textbf{Keywords:} Monetary policy surprises; FOMC statements; Forward guidance; Information channel; High-frequency identification; Sentiment analysis
...
\end{tabular}
\par\vspace{2pt}{\footnotesize Newey-West HAC standard errors with lag=4. t-statistics in parentheses. ** $p < 0.05$, * $p < 0.10$.}
\end{table}
...
\subsection{Asset Returns and Shocks}
...
\end{tabular}
\par\vspace{2pt}{\footnotesize Newey-West HAC standard errors with lag=4. ** $p < 0.05$. N = 117 for all assets.}
\end{table}
...
\begin{figure}[htbp]\centering\includegraphics[width=0.85\textwidth]{fig2_h1_scatter}\caption{Sentiment vs.\ Monetary Policy Shocks (H1)}\label{fig:fig2_h1_scatter}\end{figure}
...
\subsection{Forward Guidance Interaction}
...
\small
\begin{tabular}{p{2.2in}p{2.0in}p{1.0in}p{0.8in}}
\toprule
Variable & Source & Frequency & Coverage \\
\midrule
Target/Path shocks & Acosta (2022) & Per meeting & 1995--2022 \\
FOMC statements & Federal Reserve website & Per meeting & 2006--2026 \\
...
\begin{table}[htbp]
\centering
\caption{Regime-Specific Regression Results}
\label{tab:regime}
\begin{tabular}{lcccc}
\toprule
...
\begin{table}[htbp]
\centering
\caption{Extended Sample Results}
\label{tab:extended}
...
\begin{table}[htbp]
\centering
\caption{Sentiment Score Distribution}
