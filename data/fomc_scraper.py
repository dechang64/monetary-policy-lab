...
class FOMCScraper:
    ...
    def get_rate_decision(self, date_str: str) -> Optional[str]:
        ...
        hike_patterns = [
            "decided to raise", "increase the target range",
            "raising the target", "increasing the target",
        ]
        cut_patterns = [
            "decided to lower", "reduce the target range",
            "lowering the target", "decreasing the target",
        ]
        hold_patterns = [
            "decided to maintain", "decided to keep",
            "no change to the target range",
        ]

        for pat in hike_patterns:
