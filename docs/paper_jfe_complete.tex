...
\bottomrule
\end{tabular}
\par\vspace{2pt}{\footnotesize Sample: 117 FOMC meetings, January 2006 to July 2022. Target and path shocks are standardized to unit variance. Kuttner surprise in basis points.}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Sentiment and Monetary Policy Shocks (H1)}
\label{tab:h1}
\begin{tabular}{lccc}
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig1_sentiment_shocks}
\caption{Sentiment Scores and Monetary Policy Shocks over Time}
\label{fig:sentiment_shocks}
\end{figure}
...
\begin{table}[htbp]
\centering
\caption{Data Source Comparison: Rate Change vs.\ High-Frequency Shocks}
...
\begin{table}[htbp]
\centering
\caption{Asset Returns and Monetary Policy Shocks (H2)}
\label{tab:h2}
\begin{tabular}{lcccc}
\toprule
Asset \& $\beta_{\text{target}}$ \& $t$ \& $\beta_{\text{path}}$ \& $t$ \\
\midrule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{fig2_h1_scatter}
\caption{Sentiment vs.\ Monetary Policy Shocks (H1)}
...
\begin{table}[htbp]
\centering
\caption{Forward Guidance Period Interaction (H4)}
\label{tab:h4}
\begin{tabular}{lcc}
\toprule
 \& S\&P 500 \& NASDAQ \\
...
\begin{table}[htbp]
\centering
\caption{Financial Sector Event Study: Average Abnormal Returns on FOMC Days}
\label{tab:event}
\begin{tabular}{lc}
\toprule
Statistic \& Value \\
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig4_financial_event_study}
\caption{Financial Sector Abnormal Returns on FOMC Days}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{fig7_sentiment_by_regime}
\caption{Sentiment Distribution by Monetary Policy Regime}
\label{fig:regime}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{fig5_comparison}
\caption{Data Source Comparison: Rate Change vs.\ High-Frequency Shocks}
